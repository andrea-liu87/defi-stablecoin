...
library  OracleLib {
    ...
    function checkStaleLatestRoundData(AggregatorV3Interface pricefeed) public view returns (uint80 roundId, int256 answer, 
    uint256 startedAt, uint256 updatedAt, uint80 answeredInRound) {
        (roundId, answer, 
    startedAt, updatedAt, answeredInRound) = pricefeed.latestRoundData();
